...
MyGesturesPrefs_FILES = Preferences/MGSettingsController.m Preferences/MGBlacklistController.m Preferences/MGActionPickerController.m Preferences/MGLinksController.m
