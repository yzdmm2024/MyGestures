...
MyGestures_FRAMEWORKS = UIKit Foundation CoreGraphics AVFoundation QuartzCore
...
MyGesturesPrefs_FILES = Preferences/MGSettingsController.m
MyGesturesPrefs_INSTALL_PATH = /Library/PreferenceBundles
MyGesturesPrefs_FRAMEWORKS = UIKit Foundation
